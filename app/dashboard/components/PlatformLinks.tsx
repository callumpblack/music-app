    ...
    <div className="flex flex-wrap gap-1.5">
      {spotifyUrl && (
        <a
          ...
          className={`${linkClass} bg-[#1DB954]/15 text-[#15803d] hover:bg-[#1DB954] hover:text-white`}
        >
      ...
      {appleMusicUrl && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className={`${linkClass} bg-[#fa243c]/10 text-[#c41e35] hover:bg-[#fa243c] hover:text-white`}
        >
          <svg viewBox="0 0 24 24" fill="currentColor" className="h-3.5 w-3.5" aria-hidden="true">
      ...
      {bandcampUrl && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className={`${linkClass} bg-[#1da0c3]/15 text-[#11718a] hover:bg-[#1da0c3] hover:text-white`}
        >
          <svg viewBox="0 0 24 24" fill="currentColor" className="h-3.5 w-3.5" aria-hidden="true">
