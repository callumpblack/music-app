const FEATURES = [
  ...
  },
  {
    ...
    color: "bg-primary-faint text-primary-soft",
    icon: (
  ...
  },
  {
    ...
    color: "bg-mint/15 text-emerald-300",
    icon: (
    ...
    <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
      ...
      <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {FEATURES.map((feature) => (
          <div
            key={feature.title}
            className="rounded-3xl border border-edge bg-card p-6 shadow-sm transition-shadow duration-200 hover:shadow-md hover:shadow-black/40"
          >
            <span
